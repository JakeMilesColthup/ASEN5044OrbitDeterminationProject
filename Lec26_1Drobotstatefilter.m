...
% figure(3), 
% sgtitle(['1D Robot State Prediction Results for \Delta t = ',num2str(deltaT)])
% subplot(211)
...
figure(4), 
sgtitle(['1D Robot State Filtering Results for \Delta t = ',num2str(deltaT)])
subplot(211)
...
figure(5), 
sgtitle(['1D Robot State Estimation Errors for \Delta t = ',num2str(deltaT)])
subplot(211)
...
plot(tvec,2*sqrt(squeeze(Pk_pred_hist(1,1,:))'),'c--','LineWidth',1.5)
plot(tvec,-2*sqrt(squeeze(Pk_pred_hist(1,1,:))'),'c--','LineWidth',1.5)
...
plot(tvec,2*sqrt(squeeze(Pk_filt_hist(2,2,:))'),'r--','LineWidth',2)
plot(tvec,-2*sqrt(squeeze(Pk_filt_hist(2,2,:))'),'r--','LineWidth',2)
...
plot(tvec,2*sqrt(squeeze(Pk_pred_hist(1,1,:))'),'m--','LineWidth',1.5)
plot(tvec,-2*sqrt(squeeze(Pk_pred_hist(1,1,:))'),'m--','LineWidth',1.5)
